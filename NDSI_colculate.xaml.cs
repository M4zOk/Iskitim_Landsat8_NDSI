...
namespace Iskitim
{
    public partial class NDSI_colculate : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            // запрос у пользователя 3 изображений
            ...
            Console.WriteLine("Введите путь к третьему изображению:");
            string imgPath3 = Console.ReadLine();
            ...
            //System.Diagnostics.Process.Start("UserIMGS/processed_image.tif");

            Console.WriteLine("Обработка изображений завершена. Нажмите любую клавишу для выхода.");
        }
    }
}
